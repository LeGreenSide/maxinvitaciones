const WhatsAppButton = ({ invitationTitle, fullWidth = false }) => {
  const phoneNumber = '56987401906';
  const message = invitationTitle
    ? `Hola! Quiero cotizar la invitación "${invitationTitle}" 🎉`
  ...
  return (
    <a
      ...
      class={`inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-3xl shadow-lg transition-colors px-5 py-3 ${
